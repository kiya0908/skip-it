...
const RelatedGames = () => {
  ...
  return (
    <section className="py-8 bg-[#33b3fa]">
      <div className="max-w-[1920px] mx-auto px-2 sm:px-3 lg:px-4">
        ...
        <div className="text-center">
          <Link href="/games"
            className="inline-block bg-white text-[#33b3fa] px-8 py-3 rounded-lg font-bold text-lg hover:bg-gray-100 transition-colors duration-300 shadow-lg hover:shadow-xl">
            More Games
          </Link>
        </div>
      </div>
