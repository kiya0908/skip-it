...
export const metadata: Metadata = {
  title: 'Terms of Service - Skip It! Game',
  description: 'Read the terms of service for using Skip It! Game.',
  keywords: 'skip it game terms of service, user agreement, game rules',
  openGraph: {
    ...
    url: 'https://skipit.top/terms', // 请替换为您的实际页面URL
    type: 'website',
  },
  robots: "index, follow",
  alternates: {
    canonical: 'https://skipit.top/terms',
  },
};
        ...
        <div className="bg-white shadow-lg rounded-lg p-6 sm:p-8">
          ...
          <div className="text-left mb-8">
            ...
            <p className="text-gray-700">
              By accessing and playing games on Skip It! Game, you agree to be bound by these Terms of Service. If you do not agree to these terms, please do not use our website.
            </p>
          </div>
